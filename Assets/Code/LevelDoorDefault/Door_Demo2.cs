...
public class Door_Demo2 : MonoBehaviour
{
    ...
    private DoorManagerDemo_2 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManagerDemo_2>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if(collision.gameObject.GetComponent<Door_Demo2>() != null)
        {
            
            TouchDoorNUM = collision.GetComponent<Door_Demo2>().doorNUM;

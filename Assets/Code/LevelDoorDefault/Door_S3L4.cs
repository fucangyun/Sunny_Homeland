...
public class Door_S3L4 : MonoBehaviour
{
    ...
    private DoorManager_S3L4 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S3L4>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if(collision.gameObject.GetComponent<Door_S3L4>() != null)
        {
            
            TouchDoorNUM = collision.GetComponent<Door_S3L4>().doorNUM;

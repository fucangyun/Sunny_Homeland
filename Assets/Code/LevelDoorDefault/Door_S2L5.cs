...
public class Door_S2L5 : MonoBehaviour
{
    ...
    private DoorManager_S2L5 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S2L5>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Door_S2L5>() != null)
        {

            TouchDoorNUM = collision.GetComponent<Door_S2L5>().doorNUM;

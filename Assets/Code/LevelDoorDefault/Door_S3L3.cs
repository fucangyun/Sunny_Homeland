...
public class Door_S3L3 : MonoBehaviour
{
    ...
    private DoorManager_S3L3 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S3L3>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Door_S3L3>() != null)
        {

            TouchDoorNUM = collision.GetComponent<Door_S3L3>().doorNUM;

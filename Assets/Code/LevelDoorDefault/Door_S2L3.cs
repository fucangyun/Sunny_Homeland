...
public class Door_S2L3 : MonoBehaviour
{
    ...
    private DoorManager_S2L3 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S2L3>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Door_S2L3>() != null)
        {

            TouchDoorNUM = collision.GetComponent < Door_S2L3>().doorNUM;

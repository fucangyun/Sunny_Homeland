...
public class Door_S1L5 : MonoBehaviour
{
    ...
    private DoorManager_S1L5 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S1L5>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Door_S1L5>() != null)
        {

            TouchDoorNUM = collision.GetComponent<Door_S1L5>().doorNUM;

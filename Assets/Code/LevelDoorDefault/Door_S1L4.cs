...
public class Door_S1L4 : MonoBehaviour
{
    ...
    private DoorManager_S1L4 doorManager;

    void Start()
    {
        doorManager = FindObjectOfType<DoorManager_S1L4>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Door_S1L4>() != null)
        {

            TouchDoorNUM = collision.GetComponent<Door_S1L4>().doorNUM;
